<?php
    ...
    if(isset($_POST['confirm_booking']))
    {
        ...
        $query = "UPDATE booking_order SET booking_status=?, trans_amt=?, trans_status=?, down_payment_confirmed_by=? WHERE booking_id=?";
        $values = ['reserved',$frm_data['down_payment'],'reserved',$_SESSION['adminName'],$frm_data['booking_id']];
