                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($row = mysqli_fetch_assoc($data))
                                    {
                                        ...
                                        if($row['seen']!=1)
                                        {
                                            $seen = "<a href='?seen=$row[sr_no]' class='btn btn-sm rounded-pill btn-primary mb-2' onclick='return confirm(\"Mark as read?\")'>
                                                <i class='bi bi-check'></i> Mark as read
                                            </a><br>";
                                        }
                                        $seen .= "<a href='?del=$row[sr_no]' class='btn btn-sm rounded-pill btn-danger' onclick=\"return confirm('Are you sure you want to delete?')\"><i class='bi bi-trash'></i> Delete</a>";
