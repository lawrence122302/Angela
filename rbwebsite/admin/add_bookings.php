...
<body class="bg-light">
                        ...
                        <form id="booking_form">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <h6>User Account:</h6>
                                    <select class="form-select shadow-none bg-light mb-4" id="userAccountDropdown">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select class="form-select shadow-none bg-light mb-4" id="accommodationDropdown">
    ...
    <script src="scripts/add_bookings.js"></script>
