...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold h-font text-center">Take a Virtual Tour!</h2>
        <div class="h-line bg-dark"></div>
        <p class="text-center mt-3">
            Dive into our 360-degree virtual tour and explore the stunning pools at Angela’s Private Pool.<br>
            Experience the beauty and tranquility of each private pool, from the vibrant blue waters to the relaxing surroundings.<br>
            Get a closer look at the perfect setting for your next family gathering or celebration.<br>
            Discover your oasis today!
        </p>
    </div>
