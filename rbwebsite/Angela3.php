...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold h-font text-center">Angela 3</h2>
            ...
            <div class="col-lg-12 col-md-auto mb-5 px-auto">
                <div class="bg-white rounded shadow py-4 d-flex flex-column align-items-center">
                    <div class="iframe-container">
                        <iframe allowFullScreen="true" allow="accelerometer; magnetometer; gyroscope" src="https://panoraven.com/en/embed/KLCeVwUv5B"></iframe>
                    </div>
                </div>
            </div>
        </div>
