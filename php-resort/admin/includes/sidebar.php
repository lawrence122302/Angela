            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="category-add.php">Add Angela</a>
                        <a class="nav-link" href="category-view.php">View Angela's</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapsePosts" aria-labelledby="Posts" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="post-add.php">Add Guest</a>
                        <a class="nav-link" href="post-view.php">View Guests</a>
                    </nav>
                </div>
